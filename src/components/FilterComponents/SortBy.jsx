    ...
    return (
        <article>
            ...
            <label className="text-[14px] font-semibold w-full border-[2px] rounded-xl px-3 py-2.5 border-[#282B30] flex place-items-center">
                <select name="SortBy" id="sortby" onChange={handleSortBy} className="w-full appearance-none bg-transparent text-[#D2D5DA]">
                    ...
                    <option value="population" selected className="text-[#1A1B1D]">Population</option>
                </select>
